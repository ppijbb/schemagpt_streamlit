    ...
    with st.form("문진"):
        ...
        if submitted:
            form_data = ["test",
                         ...
                         short_pattern_7, short_general_1, short_pattern_2, short_pattern_8,
                         short_nutrition_1, short_nutrition_3, short_nutrition_6, short_nutrition_9]
            st.write(form_data)
            st.write(sum(form_data[1:]))
            st.write(scale_severity(form_data))
...
with tab2:
    ...
    with st.form("세부 평가지"):
        ...
        if submitted:
            form_data = ["test",
                         general_1, general_2, pattern_3, pattern_4, pattern_5, general_6,
                         pattern_7, pattern_8, pattern_9, pattern_10, pattern_11,
                         general_12, general_13, general_14, nutrition_15, blood_16,
                         blood_17, blood_18, blood_19, blood_20,  nutrition_21, nutrition_22,
                         blood_23, general_24, nutrition_25, blood_26, blood_27, nutrition_28,
                         nutrition_29, nutrition_30, nutrition_31, nutrition_32, blood_33,]
            st.write(len(form_data), form_data)
            st.write(heq(form_data))
with tab3:
